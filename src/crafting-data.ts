  ...
  recipes: [
    {
      ...
      outputs: [{ material: 'Extractor Kit', amount: 1 }],
    },

    {
      ...
      outputs: [{ material: 'Mining Head', amount: 1 }],
    },

    {
      name: 'Recipe 3',
      duration: 30,
      inputs: [{ material: 'Steel', amount: 4 }],
      outputs: [{ material: 'Steel Beam', amount: 3 }],
    },

    {
      name: 'Recipe 4',
      duration: 25,
      inputs: [{ material: 'Steel', amount: 3 }],
      outputs: [{ material: 'Steel Plate', amount: 4 }],
    },

    {
      ...
      outputs: [{ material: 'Structural Frame', amount: 2 }],
    },
...

    {
      ...
      outputs: [{ material: 'Steel', amount: 3 }],
    },

    {
      ...
      outputs: [{ material: 'Hydraulic Actuator', amount: 2 }],
    },

    {
      ...
      outputs: [{ material: 'Bearing Assembly', amount: 4 }],
    },

    {
      name: 'Recipe 10',
      duration: 22,
      inputs: [{ material: 'Polymer Resin', amount: 3 }],
      outputs: [{ material: 'Polymer Housing', amount: 5 }],
    },

    {
      ...
      outputs: [{ material: 'Polymer Resin', amount: 5 }],
    },

    {
      ...
      outputs: [{ material: 'Lubricant', amount: 2 }],
    },

    {
      name: 'Recipe 13',
      duration: 20,
      inputs: [{ material: 'Iron Ore', amount: 5 }],
      outputs: [{ material: 'Iron Ingot', amount: 2 }],
    },

    {
      ...
      outputs: [{ material: 'Power Distributor', amount: 2 }],
    },

    {
      ...
      outputs: [{ material: 'Electric Motor', amount: 2 }],
    },

    {
      ...
      outputs: [{ material: 'Magnet Assembly', amount: 3 }],
    },

    {
      name: 'Recipe 17',
      duration: 20,
      inputs: [{ material: 'Copper Ingot', amount: 2 }],
      outputs: [{ material: 'Copper Wire', amount: 6 }],
    },

    {
      ...
      outputs: [{ material: 'Fuel Cell', amount: 3 }],
    },

    {
      ...
      outputs: [{ material: 'Circuit Board', amount: 4 }],
    },

    {
      ...
      outputs: [{ material: 'Circuit Board', amount: 3 }],
    },

    {
      ...
      outputs: [{ material: 'Insulation', amount: 5 }],
    },

    {
      ...
      outputs: [{ material: 'Insulation', amount: 4 }],
    },

    {
      name: 'Recipe 23',
      duration: 25,
      inputs: [{ material: 'Silica Sand', amount: 2 }],
      outputs: [{ material: 'Silicon', amount: 2 }],
    },

    {
      name: 'Recipe 24',
      duration: 45,
      inputs: [{ material: 'Rare Earth Ore', amount: 6 }],
      outputs: [{ material: 'Rare Earth Concentrate', amount: 1 }],
    },

    {
      ...
      outputs: [{ material: 'Ceramic Powder', amount: 2 }],
    },

    {
      ...
      outputs: [{ material: 'Industrial Acid', amount: 3 }],
    },

    {
      name: 'Recipe 27',
      duration: 16,
      inputs: [{ material: 'Saline Brine', amount: 6 }],
      outputs: [{ material: 'Water', amount: 5 }],
    },

    {
      name: 'Recipe 28',
      duration: 22,
      inputs: [{ material: 'Copper Ore', amount: 5 }],
      outputs: [{ material: 'Copper Ingot', amount: 2 }],
    },

    {
      ...
      outputs: [{ material: 'Alloy Plate', amount: 3 }],
    },

    {
      name: 'Recipe 30',
      duration: 35,
      inputs: [{ material: 'Aluminium Ore', amount: 6 }],
      outputs: [{ material: 'Aluminium Ingot', amount: 2 }],
    },
    {
      name: 'Recipe 31',
      duration: 24,
      ...
      outputs: [{ material: 'Ceramic Powder', amount: 3 }],
    },
  ],
